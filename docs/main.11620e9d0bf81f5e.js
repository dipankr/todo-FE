...
TodoListComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
  ...
  decls: 11,
  vars: 1,
  consts: [[1, "container"], [1, "row", "mt-3"], [1, "col-sm"], [1, "card", "p-4"], [1, "row", "input-group", "mb-3"], [1, "col-sm-11"], ["type", "text", "placeholder", "New task...", "aria-label", "New task", "aria-describedby", "basic-addon2", 1, "form-control", 3, "keyup"], [1, "col-sm-1"], ["type", "button", 1, "btn", "btn-outline-dark", 3, "click"], ["class", "row m-0 pt-3", 4, "ngFor", "ngForOf"], [1, "row", "m-0", "pt-3"], [1, "row", "m-0", "list-group"], [1, "col-sm", "list-group-item", "d-flex"], ["type", "checkbox", "id", "customCheck1", 1, "custom-control-input"], ["for", "customCheck1", 1, "custom-control-label", "ms-3"]],
